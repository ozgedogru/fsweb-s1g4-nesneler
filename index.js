...
function MenuElemaniOlustur(isim, fiyat, kategori) {
  const menuElemani = {};
  menuElemani.isim = isim;
  menuElemani.fiyat = fiyat;
  menuElemani.kategori = kategori;
...
const burger = {
  ...
  indirim: function (musteri) {
    ...
    hesap = this.fiyat * (1 - indOrani);
    return hesap;
  },
};
console.log(`Ogretmen icin indirimli fiyat: ${burger.indirim("öğretmen")}`);
console.log(`Ogrenci icin indirimli fiyat: ${burger.indirim("öğrenci")}`);
console.log(`Digerleri icin indirimli fiyat: ${burger.indirim("diger")}`);
...
*/
const bilAhmet = degerlendirmeler[5]["geribildirim"];
console.log(`Ahmet'in geribildirimi: ${bilAhmet}`);
...
console.log(
  "Reyna'nin sonradan eklenen geribildirimi:",
  degerlendirmeler[7]["geribildirim"]
);
...
function DegerlendirmeEkle(arr, isim, puan, geribildirim) {
  const newObj = { isim, puan, geribildirim };
